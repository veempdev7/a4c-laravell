...
<div id="container">
              ...
              <div align="center">
                <table width="1000" border="0" bgcolor="#FFFFFF">
                  ...
                  <tr>
                    ...
                    Latest Actual International Data | {{ count($rst_aportdrop) }} Leading World Airports
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" class="emmahelveticaa16darkgreylight">Next update: {{ DateHelper::getUpdateDates()['nxtupdateYr'] }}</td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      ...
                      <div class="section group">
                        <!-- First form -->
                        <form action="{{ route('airports.airportsactualsint') }}" method="post" name="form1" class="formtest" id="form3">
                        @csrf
                        ...
                        <!-- Second form -->
                        <form action="{{ route('airports.airportsactualsint') }}" method="post" name="form2" class="formtest" id="form4">
                        @csrf
                          <div class="col span_1_of_3">
                        ...
                        <!-- Third form -->
                        <form action="{{ route('airports.airportsactualsint') }}" method="post" name="form2" class="formtest" id="form5">
                        @csrf
                          <div class="col span_1_of_3">
                            <!-- Same select ID, but a separate form -->
                            <select name="searchAPID" size="25" class="a-10-b-listmenu160bl select_box" id="searchAPID">
                    ...
                    <td>
                      <div class="mlr_6_per">
                        ...
                        <div class="row">
                          ...
                          <div class="wd_50">
                            <div id="latestIntPaxChange" style="width:100%; height: 367px;align:center; margin-top:15px;"></div>
                          </div>
                        </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <div class="mlr_6_per">
                        ...
                        <div class="row">
                          ...
                          <div class="wd_50">
                            <div id="latestIntPaxNumber" style="width:100%; height: 367px;align:center; margin-top:15px;"></div>
                          </div>
                        </div>
                      </div>
                    </td>
                            ...
                            <table width="100%" border="0" bgcolor="#F1F1F1">
                              ...
                              <tr>
                                ...
                                <td class="emmahelveticaa18darkgrey">
                                  <form id="formdown1" method="post" action="{{ url('airports/airportsactualsint') }}">
                                    @csrf
  ...
  <script type="text/javascript">
    var latestIntPaxChange = @json($latestIntPaxChange);

    var chart1 = AmCharts.makeChart("latestIntPaxChange", {
      theme: "none",
      type: "serial",
      startDuration: 1,
      dataProvider: latestIntPaxChange,
    ...
    var latestIntPaxNumber = @json($latestIntPaxNumber);
        var chart = AmCharts.makeChart("latestIntPaxNumber", {
            theme: "none",
            type: "serial",
            startDuration: 1,
            dataProvider: latestIntPaxNumber,
            autoMargins: false,
            marginLeft: 40,
            marginBottom: 30,
            marginRight: 0,
