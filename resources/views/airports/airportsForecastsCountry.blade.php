...
<div id="container">
    ...
    <td align="center" class="emmahelveticaa26darkgrey">
        Country Forecast {{ $startMonthYear }} {{ $monthLastYear }} | {{ $ctrysum[0]->countryname; }}
    </td>
</tr>
</tr>
<tr><td>&nbsp;</td></tr>
        ...
        <div class="mlr_6_per">
            <div class="row">
                <div class="wd_50">
                    ...
                    <div class="amchart">
                    <div id="ctrypassenger_chart" style="width:100%; height: 367px;align:center; margin-top:15px;">
                    </div>
                    </div>
                ...
                <div class="wd_50">
                    <div class="contentnn demo-yx" id="scroll3">
                        <table class="table_ip_actual">
                            ...
                            <tbody>
                                @foreach($annsumchange as $change)
                                    <tr>
                                        <td>{{ $change->Year }}</td>
                    ...
                    <div class="amchart">
                    <div id="ctrypassengerchange_chart" style="width:100%; height: 367px;align:center; margin-top:15px;">
                    </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mlr_6_per">
            <div class="row">
                ...
                <div class="wd_50">
                    <div class="contentnn demo-yx" id="scroll4">
                        <table class="table_ip_actual">
                            ...
                            <tbody>
                                @foreach($ctrymonchange as $monchange)
                                    <tr>
                    ...
                    <div class="amchart">
                    <div id="rollingchangectry_chart" style="width:100%; height: 367px;align:center; margin-top:15px;">
                    </div>
                    </div>
                </div>
                ...
                <div class="wd_50">
                    ...
                    <div class="amchart">
                    <div id="rollingmothlyctry_chart" style="width:100%; height: 367px;align:center; margin-top:15px;">
                    </div>
                    </div>
                </div>
            </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <form id="formdown1" name="formdown1" method="post" action="{{ route('airports.csvpages.airportsforecastscountry_annual') }}">
                        @csrf
                    ...
                    <form id="formdown13" name="formdown13" method="post" action="{{ route('airports.csvpages.airportsforecastscountry_singlemonthly') }}">
                        @csrf
                        <input name="export" type="submit" class="whit_btn" id="export" 
                    ...
                    <form id="formdown2" name="formdown2" method="post" action="{{ route('airports.csvpages.airportsforecastscountry_quarterly') }}">
                        @csrf
...
<script type="text/javascript">
    var chartDataTotal  = @json($ctryGraphData);
    var chartTotal = AmCharts.makeChart("ctrypassenger_chart", {
        theme: "none",
        type: "serial",
        startDuration: 1,
        dataProvider: chartDataTotal,
...
<script type="text/javascript">
    var chartDataChange = @json($ctryChangeGraphArray);

    var chartChange = AmCharts.makeChart("ctrypassengerchange_chart", {
        theme: "none",
        type: "serial",
        startDuration: 1,
...
<script>
    var chartData4 = @json($rollingchangectry_chart);

    var chart = AmCharts.makeChart("rollingchangectry_chart", {
        theme: "none",
        type: "serial",
        startDuration: 1,
...
<script type="text/javascript">
        var chartData4 = @json($latestRollingArr);
        var chart = AmCharts.makeChart("rollingmothlyctry_chart", {
            theme: "none",
            type: "serial",
            startDuration: 1,
            dataProvider: chartData4,
