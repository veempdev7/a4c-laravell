...
<div id="container">
    ...
    <td align="center" class="emmahelveticaa26darkgrey">
        City Forecast {{ $start1 }} {{ $end }} | {{ $citySummary[0]->city_apref; }}
    </td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
                ...
                <div class="wd_50">
                    <div class="contentnn demo-yx" id="scroll2">
                        <table class="table_ip_actual">
                            ...
                            <tbody>
                                @foreach($annualSummary as $annual)
                                    <tr>
                                        <td>{{ $annual->Year }}</td>
                    ...
                    <div class="amchart">
                    <div id="citypassenger_chart" style="width:100%; height: 367px;align:center; margin-top:15px;">
                    </div>
                    </div>
                ...
                <div class="wd_50">
                    <div class="contentnn demo-yx" id="scroll3">
                        <table class="table_ip_actual">
                            ...
                            <tbody>
                                @foreach($annualSummaryChanges as $change)
                                    <tr>
                                        <td>{{ $change->Year }}</td>
                    ...
                    <div class="amchart">
                    <div id="citychangepassenger_chart" style="width:100%; height: 367px;align:center; margin-top:15px;">
                    </div>
                    </div>
                </div>
            </div>
                ...
                <div class="wd_50">
                    <div class="contentnn demo-yx" id="scroll4">
                        <table class="table_ip_actual">
                            ...
                            <tbody>
                                @foreach($monthlyForecastChanges as $monchange)
                                    <tr>
                    ...
                    <div class="amchart">
                    <div id="rollingchange_chart" style="width:100%; height: 367px;align:center; margin-top:15px;">
                    </div>
                    </div>
                </div>
                ...
                <div class="wd_50">
                    <div class="contentnn demo-yx" id="scroll5">
                        <table class="table_ip_actual">
                            ...
                            <tbody>
                                @foreach($monthlyForecasts as $monthly)
                                    <tr>
                                        <td>{{ $monthly->Year }}</td>
                                        <td>{{ $monthly->Month }}</td>
                    ...
                    <div class="amchart">
                    <div id="rollingmothly_chart" style="width:100%; height: 367px;align:center; margin-top:15px;">
                    </div>
                    </div>
                </div>
            </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="emmahelveticaa15darkgreylight">
                    Use this section to see the detail within the city forecast and download specific data series directly to excel. Click the buttons below to get your data.
                  </td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td>
                    <form id="formdown1" method="post" action="{{ route('airports.csvpages.airportsforecastscity_annual') }}">
                      @csrf
                      <input name="export" type="submit" class="whit_btn" id="export" value="Annual Passengers | {{ $start1 }}{{ $end }}" />
                    </form>

                    <form id="formdown12" method="post" action="{{ route('airports.csvpages.airportsforecastscity_singlemonthly') }}">
                      @csrf
                      <input name="export" type="submit" class="whit_btn" id="export" value="Monthly Passengers | {{ $start1 }}" />
                    </form>

                    <form id="formdown2" method="post" action="{{ route('airports.csvpages.airportsforecastscity_quaterly') }}">
                      @csrf
                      <input name="exportQuarterly" type="submit" class="whit_btn" id="exportQuarterly" value="Quarterly Passengers | {{ $start1 }} - {{ $start1 + 4 }}" />
                    </form>
                  </td>
                  <td>&nbsp;</td>
                </tr>
...
<script type="text/javascript">
        var chartData4 = @json($citypassenger_chart);

        AmCharts.makeChart("citypassenger_chart", {
            theme: "none",
            type: "serial",
            startDuration: 1,
...
<script>
        var chartData4 = {!! json_encode($citychangepassenger_chart) !!};

        var chart = AmCharts.makeChart("citychangepassenger_chart", {
            theme: "none",
            type: "serial",
            startDuration: 1,
            dataProvider: chartData4,
...
<script type="text/javascript">
        var chartData4 = @json($rollingmothly_chart);

        var chart = AmCharts.makeChart("rollingmothly_chart", {
            theme: "none",
            type: "serial",
            startDuration: 1,
            dataProvider: chartData4,
    ...
    <script>
        var chartData4 = {!! json_encode($rollingchange_chart) !!};

        var chart = AmCharts.makeChart("rollingchange_chart", {
            theme: "none",
            type: "serial",
            startDuration: 1,
            dataProvider: chartData4,
