...
AmCharts.wrappedText = function(a, b, c, d, e, f, g, h, k) {
    ...
    if (l) {
        ...
        if (n.width > h) {
            ...
            if (isNaN(q)) {
                if (0 == k)
                    for (p = 1; p < n; p++) q = Math.round(b.length / n * p), b = b.substr(0, q) + m + b.substr(q);
...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) c = !0;
            ...
            for (f = p; f < q; f += n)
                if (p = t * f + this.min, d && this.max - this.min > 5 * this.min && (p -= this.min), p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p)
            ...
            if (d.valueAxis == this) {
                ...
                if (!isNaN(a.startTime) && (l = a.categoryAxis)) {
                    ...
                    var m = new Date(a.startTime + minDuration / 2),
                        n = AmCharts.resetDateToMin(new Date(a.startTime),
                            l.minPeriod).getTime();
...
AmCharts.RecItem = AmCharts.Class({
    construct: function(a, b, c, d, e, f, g, h, k, l, m) {
        ...
        Z && (Z.attr({
            "text-anchor": W
        }), Z.translate(G, A), 0 !== m && Z.rotate(-m, a.chart.backgroundColor), a.allLabels.push(Z), " " != c && (this.label = Z));
    ...
    brr: function() {
        ...
        if ("amcharts.com" != b || !0 === this.inIframe()) {
            ...
            var f = "#",
                ...
                "JavaScript charts",
                h = "";
            "ammap" == this.product && (f = "http://www.ammap.com/javascript-maps/", g = "Interactive JavaScript maps", h = "");
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function() {
        ...
        var l = this.useNegativeColorIfDown,
            ...
            v = [],
            s = [],
            u, x, F, B, z = this.chart.graphs.length,
            I, E = this.dx / this.tcc,
            H = this.dy / this.tcc,
            V = f.stackType,
            T = this.start,
            fa = this.end,
            aa = this.scrollbar,
            ga = this.categoryAxis,
            Na = this.baseCoord,
        ...
        var S, y, Z, eb = n + 1,
            ...
            Wa = 0,
            gb = 0,
            hb, ib, Xa, Ya, jb = this.fillColorsR,
        ...
        if (!(aa || "line" != g && "smoothedLine" != g && "step" != g || (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Da && void 0 == wa || l))) {
            ...
            var Aa = f.getCoordinate(Ja),
                Cb = f.getCoordinate(f.max);
        ...
        if ("line" == g || "step" == g || "smoothedLine" ==
            ...
            if (0 < T) {
                for (J = T - 1; - 1 < J; J--)
                    if (S = d[J], y = S.axes[f.id].graphs[b], Z = y.values.value, !isNaN(Z)) {
                        T = J;
                        break
                    }
                if (this.lineColorField)
                    for (J = T; - 1 < J; J--)
                        if (S = d[J], y = S.axes[f.id].graphs[b], y.lineColor) {
                            this.bulletColorSwitched = this.lineColorSwitched = y.lineColor;
                            break
                        }
                if (this.fillColorsField)
                    for (J = T; - 1 < J; J--)
                        if (S = d[J], y = S.axes[f.id].graphs[b], y.fillColors) {
                            this.fillColorsSwitched = y.fillColors;
                            break
                        }
                if (this.dashLengthField)
                    for (J = T; - 1 < J; J--)
                        if (S = d[J], y = S.axes[f.id].graphs[b], !isNaN(y.dashLength)) {
        ...
        for (J = T; J <= fa; J++) {
            ...
            if (l && void 0 == this.openField)
                for (var kb = J + 1; kb < d.length && (!d[kb] ||
            ...
            if (va) {
                ...
                var ha =
                    S.x[ga.id],
                    La = this.periodSpan - 1,
                    la = Math.floor(A / 2) + Math.floor(La * A / 2),
                    za = la,
                    cb = 0;
                ...
                switch (g) {
                    case "line":
                        if (isNaN(U)) w || (this.drawLineGraph(v, s, P, Q), v = [], s = [], P = [], Q = []);
                        else {
                    ...
                    case "candlestick":
                        if (!isNaN(ia) && !isNaN(U)) {
                            ...
                            if (q) {
                                ...
                                nb && U >= ia && (Ka = 0);
                                var qa = new AmCharts.Cuboid(e, L, ca, E, H, Ca, Ka, O, oa, X, ja, t, q, $, Sa),
                                    sb, tb;
                    ...
                    case "ohlc":
                        if (!(isNaN(ia) || isNaN(lb) || isNaN(mb) || isNaN(U))) {
                            ...
                            if (q) {
                                var xb = C - h / 2,
                                    xb = AmCharts.fitToBounds(xb, 0, n),
                                    Ib = AmCharts.fitToBounds(C, 0, n),
                                    yb = C + h / 2,
                                ...
                                var zb = D - h / 2,
                                    zb = AmCharts.fitToBounds(zb,
                                        0, m),
                                    Jb = AmCharts.fitToBounds(D, 0, m),
                                    Ab = D + h / 2,
                ...
                if (!aa && !isNaN(U)) {
                    ...
                    if (this.end - this.start <= Kb || 0 === Kb) {
                        var Vb = this.createBullet(y, da, ea, J),
                            Lb = this.labelText;
                        if (Lb) {
    ...
    drawLineGraph: function(a, b, c,
        ...
        if (1 < a.length) {
            ...
            r && (p = r);
            var r = e.fillColorsR,
                t = e.fillColorsSwitched;
            t && (r = t);
            var w = e.dashLength;
            (t = e.dashLengthSwitched) && (w = t);
            var t = e.negativeLineColor,
                v = e.negativeFillColors,
                s = e.negativeFillAlphas,
                u = e.baseCoord;
            ...
            if (0 < f || 0 < s)
                if (n = a.join(";").split(";"), q = b.join(";").split(";"), m = g.type, "serial" == m ? 0 < c.length ? (c.reverse(), d.reverse(), n = a.concat(c), q = b.concat(d)) : e.rotate ? (q.push(q[q.length - 1]), n.push(u),
    ...
    createBullet: function(a, b, c, d) {
        if (!isNaN(b) && !isNaN(c)) {
            ...
            n ? (n.size = f || 0, a.bulletGraphics = n) : n = {
                size: 0
            };
            n.graphDataItem = a;
            return n
        ...
        if (this.enabled) {
            ...
            if (q) {
                var r = q.x[g.id],
                    ...
                    B = this.panning,
                    z = c.graphs;
                if (c.mouseIsOver || F || B || this.forceShow)
                    if (this.forceShow = !1, B) {
                        var h = this.panClickPos,
                            c = this.panClickEndTime,
                            F = this.panClickStartTime,
                            I = this.panClickEnd,
                        ...
                        if (0 < this.cursorAlpha) {
                            ...
                            0 < w && !this.zooming ? isNaN(this.previousX) ? E.translate(s, u) : (E.translate(this.previousX, this.previousY), E.animate({
                                translate: s + "," + u
                            }, w, "easeOutSine")) : E.translate(s, u);
                            this.previousX = s;
                            this.previousY =
                                u;
                            E.show()
                        ...
                        if (a != this.previousIndex || I != this.previousMostCloseGraph)
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], z && this.valueBalloonsEnabled && w && c.balloon.enabled) {
                                ...
                                for (g = 0; g < z.length; g++)
                                    if (s = z[g], v = NaN, (!this.oneBalloonOnly || s == I) && s.showBalloon && !s.hidden && s.balloonText && ("step" == s.type && "left" == s.stepDirection && (q = this.data[a + 1]), q)) {
                                        ...
                                        if (this.showNextAvailable && isNaN(v) && a + 1 < this.data.length)
                                            for (r = a + 1; r < this.data.length; r++)
                                                if (d = this.data[r])
                                                    if (u = d.axes[s.valueAxis.id].graphs[s.id], v = u.y, !isNaN(v)) break;
                                        if (!isNaN(v)) {
                                            d = u.x;
                                            k = !0;
                                            if (t) {
                        ...
                        b ? (h = {
                            type: "changed"
                        }, h.index = a, h.chart = this.chart, h.zooming = F, h.mostCloseGraph = I, h.position = t ? f : e, h.target = this, c.fire("changed", h), this.fire("changed",
        ...
        if (l = a.graph) {
            ...
            for (q = 0; q < c.length; q++) {
                var r = c[q].axes[p.id].graphs[l.id].values,
                    t;
                for (t in r)
                    if (r.hasOwnProperty(t) && "percents" != t && "total" != t) {
                        var w = r[t];
                        w < f && (f = w);
                        w > g && (g = w)
                    }
...
AmCharts.AmCoordinateChart = AmCharts.Class({
    ...
    construct: function(a) {
       ...
       this.colors = "#CD0D74 #CD0D74 #CD0D74 #CD0D74 #CD0D74 #CD0D74 #CD0D74 #CD0D74 #CD0D74 #CD0D74 #CD0D74 #CD0D74 #CD0D74".split(" ");
...
AmCharts.AmSlicedChart = AmCharts.Class({
    ...
    construct: function(a) {
        ...
        this.colors = "#0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1 #0D52D1".split(" ");
        this.alpha = 1;
        this.groupPercent = 0;
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    var w = 1 / 180 * Math.PI,
        ...
        F = c - Math.cos((d + e) * w) * g,
        B = b + Math.sin((d + e) * w) * h,
...
AmCharts.AmDraw = AmCharts.Class({
    construct: function(a, b, c, d) {
        ...
        if (AmCharts.hasSVG) {
            ...
            b.appendChild(document.createTextNode("" + d.version));
            e.appendChild(b);
