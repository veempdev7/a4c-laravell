<?php require_once('../Connections/conn_333mysql.php'); ?><?php
   ...
   //End Restrict Access To Page   
    require_once('../includes/common/hitcounter_a4c_functions.php');
      ...
      $finalgettermcodeval = $rowgettermcodeval['code'];
      $finalapnameval = $rowgettermcodeval['aport'];
      $mergevalues = $rowgettermcodeval['aport'].' '.$rowgettermcodeval['termcode'];

      $_SESSION['sess_airport_sel']=$rowgettermcodeval['code'];

     $terminalalldata = "SELECT *, dlup.dlup_monthtxt FROM `tfc_data`  LEFT JOIN dlup ON dlup.id_dlup = tfc_data.dlup WHERE  tfc_data.termcode   LIKE '{$finalgettermcodeval}%' AND tfc_data.year > '2014' Group By tfc_data.dlup, tfc_data.dno, tfc_data.termcode ORDER BY tfc_data.dlup ASC";
                                 ...
                                 <tr>
                                    <td>
                                       <table width="100%" border="0" bgcolor="#E1E1E1">
                                          ...
                                          <tr>
                                             <td>&nbsp;</td>
                                             <td align="center" class="emmahelveticaa16darkgreybold">Air4casts Terminal Forecasts by Airport</td>
                                             <td>&nbsp;</td>
                                          </tr>
                                          <tr>
                                             <td height="10"></td>
...
<!-- added -->
                                       ...
                                       <div class="mlr_6_per">
                                          <div class="blueForm">
                                             <form action ="" id="consumernameget" name="airport" method="post">
                                                <input type="text" id="selinfog" name="selinfog" placeholder="Type an airport code" />
                                       ...
                                       <div class="">
                                          <table width="100%" id="example_unique" class="table-style-two datatable">
                                             ...
                                             <tbody>
                                                ...
                                                <?php  
                                                //while($rst_natinality = mysqli_fetch_assoc($rst_terminal)){ 
                                                   foreach($arrValArr as $resKey => $rst_natinality){
                                                   ?>  
                                                <tr class="emmahelveticaa14darkgreylight">
                                                   <!-- <td><?php //echo $rst_natinality['ctry'] ?></td> -->
                                ...
                                <tr>
                                 ...
                                 <tr id="acapChart" style="height:450px;">
                  ...
                  <td width="90%"><table width="100%" border="0" bgcolor="#F1F1F1">
                    ...
                    <tr>
                      ...
                      <td class="emmahelveticaa18darkgrey">
                        <form id="formdown1" name="formdown1" method="post" action="csvpages/airport-selector-by-terminal-csv.php">
      ...
      <script>
               ...
               jQuery('#consumernameget').on('submit', function(e) {
                  ...
                  jQuery.ajax({
                     ...
                     success: function(response){
                        jQuery('#ajaxTable').load("/terminal-forecasts/airport-selector-ajax-data.php?consumerCode="+dataconinal);
                     }   
                  });
               });
            ...
            $j(document).ready(function() {
               ...
               var allterminals ='';
                ...
                dataType.push('int');
                dataArr = <?php echo json_encode($arrTryNewData) ?>;
                allterminals = <?php echo json_encode($allterminal) ?>; 
                data    =  dataArr;
                creategraph(data, allterminals, dataType);
                ...
                $j('#consumernameget').on('submit', function(e) {
                  ...
                  $j.ajax({
                     type: "POST",
                     url: "airport-selector-ajax-graphdata.php",
                     data:'keyword='+dataconinal,
                     dataType: "json",
                        success: function(res_data){
                        
                           data = res_data['data'];
                           allterminals = res_data['arrTerminal'];
            ...
            function creategraph(data, allterminals, dataType){ 
               ...
               function createSeries(field, name, color) {
                 ...
                 series.tooltipText = name +": [b] {categoryX}: [b]{valueY}[/]";
               ...
               var k = 1;
               var series ='';
               var arrColor = ['#DC156C','#de574e','#05690','#F7A941','#2B9059','#10B3BC','#CE8E59','#4800A3','#2E2E2E'];



                  if ($j.inArray('int', dataType) != -1){
                        $j.each( allterminals, function( keyT, valueT ) {
                        console.log(valueT);
                        createSeries(valueT+'_3', valueT, arrColor[keyT]);
                  ...
                  if ($j.inArray('dom', dataType) != -1){
                        $j.each( allterminals, function( keyT, valueT ) {
                        console.log(valueT);
                        createSeries(valueT+'_4', valueT, arrColor[keyT]);
                        });
                        chartT.data = data['4'];
                  }
                  ...
                  if ($j.inArray('tot', dataType) != -1){
                        ...
                        createSeries(valueT+'_5', valueT, arrColor[keyT]);
