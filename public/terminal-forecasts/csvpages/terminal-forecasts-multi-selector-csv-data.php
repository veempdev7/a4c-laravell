<?php session_start();
   ...
   require_once('../Connections/conn_409mysql.php');
    require_once('../Connections/conn_33mysql.php');
      ...
      $csv_filename = 'TerminalForcastsMultiselect.csv';
      ...
      $output1 = fopen('TerminalForcastsMultiselectCsv.csv', 'w');
      $contents=utf8_encode("Air4casts Terminal Forecasts Download");
      fputcsv($output,array($contents));
      fputcsv($output1,array($contents));   
      fputcsv($output, array("Terminal Multi Selector"));
      fputcsv($output1, array("Terminal Multi Selector"));
      ...
      $qry ="SELECT DISTINCT(aport), code FROM tfc_termlup WHERE code IN (".$_POST['airportlist'].")";
      //echo $qry;die; 
      ...
      require_once('terminal_forecasts_multi_selector_csv_email.php');  
