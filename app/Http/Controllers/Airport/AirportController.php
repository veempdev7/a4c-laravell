    ...
    // Start Queries (using db_con_33 connection)
      ...
      $monthlyForecasts = $db->table('dlup')
          ...
          ->select('dlup.dlup_year as Year', 'dlup.dlup_monthtxt as Month', 
                   'xa_mon.fc3 as International', 'xa_mon.fc4 as Domestic', 'xa_mon.fc5 as Total')
          ->get();
...
", [$regionId]);
    ...
    return view('airports.airportsforecastsreg', compact(
        'regAnnual', 'regAnnChange', 'monthlyData', 'monthlyChange',
        'regionName', 'mailHead', 'airportForecasts', 'startMonthYear', 'monthLastYear', 'selector', 'fetchRegionForecasts','fetchAnnualRegionForecasts','regionrollinchange_chart','airportRegionRollingMonthlyForecastGraph'
    ));
}
